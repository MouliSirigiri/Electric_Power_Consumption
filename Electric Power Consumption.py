...
def line_plot_visualization(E_P_C):
    """
   Define a function to create a line plot with the Electric Power Consumption data
"""
...
def bar_plot_visualization(E_P_C):
    """
   Define a function to create a bar chart with the Electric Power Consumption data
"""
...
def pie_plot_visualization(E_P_C, year):
    """
   Define a function to create a pie chart with the Electric Power Consumption data
"""
...
def main():
    E_P_C = read_E_P_C()
    line_plot_visualization(E_P_C)
    bar_plot_visualization(E_P_C)
    pie_plot_visualization(E_P_C, '2001')
    pie_plot_visualization(E_P_C, '2014')
